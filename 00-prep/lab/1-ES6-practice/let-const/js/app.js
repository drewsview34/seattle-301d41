...
function displayPics(){
 ...
 // It threw an error because it  disabled the display of images in the web browser.  This occurs because let declarations can only be used locally, which is inside of a block. Var declaration can be used locally or globally.
 console.log(viewed);
